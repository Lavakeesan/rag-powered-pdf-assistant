    ...
    <div className="min-h-screen flex flex-col items-center justify-center p-6 bg-background relative overflow-hidden">
      ...
      <div className="w-full max-w-lg">
        ...
        <div className="glass-card rounded-[40px] p-8 md:p-12 border border-white/10 shadow-2xl">
          ...
          <button className="w-full flex items-center justify-center gap-3 bg-slate-950/40 border border-white/10 py-4 rounded-2xl font-bold text-slate-300 hover:bg-slate-900 transition-colors">
